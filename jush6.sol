...
/**
 * @title Jush6 Token Project
 * @dev credit to JapanLabs at medium
 */
/**
 * @title SafeMath
...
/**
 * @title Jush6Token 
 * @dev Contract to create the Jush6 Token
 **/
contract Jush6Token is CrowdsaleToken {
    string public constant name = "Jush6 Token";
    string public constant symbol = "J6";
